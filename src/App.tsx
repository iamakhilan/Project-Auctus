...
import { NavTabs, DesktopNavTabs } from './components/layout/NavTabs';
...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f7] text-[var(--gray-text)] font-body flex flex-col antialiased pb-safe">
      ...
      {/* Mobile footer - shorter */}
      <footer className="md:hidden w-full bg-white border-t-2 border-[#e5e5e5] py-4 text-center select-none">
        <div className="max-w-4xl mx-auto px-4 flex flex-col items-center gap-2">
          <div className="flex items-center gap-1.5">
            <span className="w-6 h-6 rounded-xl bg-[var(--green)] border-b-2 border-[var(--green-shadow)] flex items-center justify-center text-white font-black text-xs">
              ⚡
            </span>
            <span className="font-['Feather_Bold'] text-sm text-[var(--dark-blue)] tracking-wide">
              AUCTUS PRODUCTIVITY RPG
            </span>
          </div>
          <p className="text-[11px] font-bold text-[var(--gray-light)] max-w-md">
            Built with Duolingo Design System
          </p>
          <div className="text-[10px] font-extrabold text-[var(--gray-light)]">
            © 2026 AUCTUS
          </div>
        </div>
      </footer>
